...
public class LoginController {
    ...
    /*@RequestMapping("/login")
    public void login(LoginVo vo, HttpServletRequest request, HttpServletResponse
    ...
    public void getPassword(HttpServletResponse response,LoginVo vo) throws
            IOException {
        ...
        if(null==user){
            ...
            message.setFrom("m19956938620@163.com");
    ...
    public void smsControllter(HttpServletResponse resp,String phone) {
    DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI2emAWUgeaniE", "d1GRsWFIPr8k7IXDBMgDksPVm3ox7L");
    ...
    request.putQueryParameter("TemplateCode","SMS_173225282");
    ...
    public void messageQuery(HttpServletResponse response,String phone,String code) throws IOException {
        Object telAuth=jedis.boundValueOps(phone).get();
